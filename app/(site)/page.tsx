...
export default async function Home() {
  const [services, whyChooseFeatures, portfolioItems, company, slides, settings, brands] =
    await Promise.all([
      getServices(),
      getWhyChooseFeatures(),
      getPortfolioItems(),
  ...
  return (
    <>
      ...
      <HeroCarousel
        ...
        headlineAccent={settings['hero.headlineAccent']}
      ...
      <section className="py-20 sm:py-28 bg-background">
        <div className="container-wide">
          <SectionHeading
            eyebrow={settings['home.services.eyebrow']}
            title={settings['home.services.title']}
            description={settings['home.services.description']}
          />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col justify-center items-center text-center p-8 rounded-xl gradient-ocean text-white">
              <h3 className="font-heading text-xl font-semibold mb-2">
                {settings['home.services.ctaTitle']}
              </h3>
              <p className="text-white/80 text-sm mb-5">
                {settings['home.services.ctaDescription']}
              </p>
              <Button asChild className="rounded-full bg-white text-primary hover:bg-white/90">
                <Link href="/contact">{settings['home.services.ctaButton']}</Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 sm:py-28 bg-muted/40">
        <div className="container-wide">
          <SectionHeading
            eyebrow={settings['home.why.eyebrow']}
            title={settings['home.why.title']}
            description={settings['home.why.description']}
          />
      ...
      <section className="py-20 sm:py-28 bg-background">
        <div className="container-wide">
          <SectionHeading
            eyebrow={settings['home.work.eyebrow']}
            title={settings['home.work.title']}
            description={settings['home.work.description']}
          />
            ...
            {portfolioItems.slice(0, 6).map((item, idx) => (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                  ...
                  <h3 className="text-shadow-hard font-heading text-lg font-semibold text-white mb-1">
                    {item.title}
                  </h3>
                  <p className="text-shadow-hard text-sm text-white/70 line-clamp-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    {item.description}
                  </p>
                </div>
              </Link>
            ...
            <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button asChild size="lg" className="rounded-full bg-white text-primary hover:bg-white/90">
                  <Link href="/contact">{settings['home.cta.buttonPrimary']}</Link>
                </Button>
                <Button
                  asChild
                  size="lg"
